...
func (tq *TagQuery) QueryRecipes() *RecipeQuery {
	query := (&RecipeClient{config: tq.config}).Query()
...
func (tq *TagQuery) Clone() *TagQuery {
	...
	return &TagQuery{
		...
		withRecipes: tq.withRecipes.Clone(),
...
func (tq *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := tq.withRecipes; query != nil {
		if err := tq.loadRecipes(ctx, query, nodes,
...
func (tq *TagQuery) loadRecipes(ctx context.Context, query *RecipeQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Recipe)) error {
