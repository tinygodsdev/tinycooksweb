...
func (nd *NutritionDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(nutrition.Table, sqlgraph.NewFieldSpec(nutrition.FieldID, field.TypeInt))
...
func (ndo *NutritionDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{nutrition.Label}
	default:
		return nil
	}
}
